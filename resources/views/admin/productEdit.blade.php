            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                              @if(isset($product))
                              action="{{route('admin.productSave', ['id' => $product->id])}}"
                            @else
                                action="{{route('admin.productSave')}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="@if(isset($product)){{$product->name}}@endif" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value ="@if(isset($product)){{$product->price}}@endif">
                            ...
                            <div class="form-group row">
                                <label for="category_id" class="col-md-4 col-form-label text-md-right">Category_id</label>

                                <div class="col-md-6">
                                    <input id="category_id" type="text" class="form-control @error('category_id') is-invalid @enderror" name="category_id" value ="@if(isset($product)){{$product->category_id}}@endif">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="is_publish" type="text" class="form-control @error('is_publish') is-invalid @enderror" name="is_publish" value ="@if(isset($product)){{$product->is_publish}}@endif">
