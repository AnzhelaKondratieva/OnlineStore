            ...
            <div class="woocommerce-info-wrapper">
              <div class="row">
                ...
                <div class="woocommerce-info">
                  ...
                  <a href="/shop-cart">Click here to enter your code</a>
                </div>
              </div>
            </div>
            <div class="row">
              <form class="woocommerce-checkout">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group Orchid-form no-radius">
                      <label>Country *</label>
                      <select class="select2 form-control" aria-hidden="true" tabindex="-1" name="billing_country" autocomplete="country">
                ...
                <div class="woocommerce-checkout-review-order">
                  ...
                  <table class="woocommerce-checkout-review-order-table">
                    ...
                    <tbody>
                      ...
                      <tr class="cart_item">
                        <td class="product-name">Apple
                          <span class="product-quantity">× 1</span>
                        </td>
                        <td class="product-total">
                          <span class="woocommerce-Price-amount amount">
                            <span class="woocommerce-Price-currencySymbol">$</span>4.05</span>
                        </td>
                      </tr>
                    </tbody>
                    <tfoot>
                      <tr class="cart-subtotal">
                        ...
                        <td>
                          <strong>
                            <span class="woocommerce-Price-amount amount">
                              <span class="woocommerce-Price-currencySymbol">$</span>6.31</span>
                          </strong>
                        </td>
                      </tr>
                      <tr class="cart-shipping">
                        ...
                        <td>
                          <strong>
                            <span class="woocommerce-Price-amount amount">
                              <span class="woocommerce-Price-currencySymbol"></span>Flat rate</span>
                          </strong>
                        </td>
                      </tr>
