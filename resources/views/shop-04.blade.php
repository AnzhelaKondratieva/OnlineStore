  ...
  <body class="animsition">
    <div class="shop-layout-4" id="page">
      ...
      <section class="box-sm">
        <div class="container">
          <div class="row main">
            <div class="row js-product-masonry-3-columns-wrapper product-masory-3-columns-wrapper">
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-02.jpg" alt="product thumbnail" />
                    </a>
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Onion</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-03.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Bean</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-04.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Lemon</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-05.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Spinach</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-06.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-07.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Broccoli</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-08.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Brasil</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-09.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Pear</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-010.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Tomanto</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-011.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Bitter Melon</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-012.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Cucumber</a>
                    </h3>
              ...
              <figure class="item">
                <div class="product product-style-4">
                  <div class="img-wrapper">
                    <a href="/product-detail">
                      <img class="img-responsive" src="images/product/masonry-013.jpg" alt="product thumbnail" />
                    </a>
                    <div class="product-control-wrapper bottom-right">
                      <div class="wrapper-control-item">
                        <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                  ...
                  <figcaption class="desc text-center">
                    <h3>
                      <a class="product-name" href="/product-detail">Rice</a>
                    </h3>
