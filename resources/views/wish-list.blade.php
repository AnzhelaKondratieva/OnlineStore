            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <a href="/shop-detail-03">Shop Detail Version 3</a>
                  </li>
                </ul>
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <a href="/blog-detail-02">Blog Detail Version 2</a>
                  </li>
                  <li>
                    <a href="/blog-detail-03">Blog Detail Version 3</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="product-stock-status" data-title="Stock Status">
                      <a href="/product-detail">In Stock</a>
                    </td>
                    <td class="product-add-to-cart">
                      <a class="btn btn-brand" href="/cart">ADD TO CART</a>
                    </td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/product/thumb-cart-02.jpg" alt="product-thumbnail">
                    </td>
                    <td class="product-name" data-title="Product">
