...
<html>
  ...
  <body class="animsition">
    <div class="shop-detail-2 woocommerce" id="page">
      <nav id="menu">
        <ul>
          <li>
            <a href="/index">Home</a>
      ...
      <section class="sub-header shop-detail-1">
        <img class="rellax bg-overlay" src="images/sub-header/017.jpg" alt="">
                  ...
                  <div class="desc">
                    ...
                    <div class="footer-desc">
                      <form class="cart">
                        ...
                        <div class="group-btn-control-wrapper last">
                          <button class="btn-icon btn-icon-brand">
