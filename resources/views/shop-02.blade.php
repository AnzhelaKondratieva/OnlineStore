...
<html>
  ...
  <body class="animsition">
    <div class="shop-layout-2" id="page">
      <nav id="menu">
        <ul>
          <li>
            <a href="/index">Home</a>
      ...
      <section class="sub-header shop-layout-1">
        <img class="rellax bg-overlay" src="images/sub-header/016.jpg" alt="">
        ...
        <div class="container">
          <div class="product-list-wrapper">
            <div class="row">
              <div class="product-category-item-5">
                <div class="cate-thumbnail">
                  <img src="images/product/cat-01.jpg" alt="category thumbnail">
                </div>
                <div class="outter-product-wrapper">
                  <h3 class="cate-title">Vegetable</h3>
            ...
            <div class="row">
              <div class="product-category-item-5">
                <div class="cate-thumbnail">
                  <img src="images/product/cat-02.jpg" alt="category thumbnail">
                </div>
                <div class="outter-product-wrapper">
                  <h3 class="cate-title">Fruit</h3>
                  <div class="inner-product-wrapper">
                    <figure class="item">
                      <div class="product product-style-1">
                        <div class="img-wrapper">
            ...
            <div class="row">
              <div class="product-category-item-5">
                <div class="cate-thumbnail">
                  <img src="images/product/cat-03.jpg" alt="category thumbnail">
                </div>
                <div class="outter-product-wrapper">
                  <h3 class="cate-title">Meat</h3>
                  <div class="inner-product-wrapper">
                    <figure class="item">
                      <div class="product product-style-1">
                        <div class="img-wrapper">
                          <a href="/product-detail">
                            <img class="img-responsive" src="images/product/014.jpg" alt="product thumbnail">
                          </a>
                          <div class="product-control-wrapper bottom-right">
                            <div class="wrapper-control-item">
                              <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                        ...
                        <figcaption class="desc text-center">
                          <h3>
                            <a class="product-name" href="/product-detail">Steak</a>
                          </h3>
                    ...
                    <figure class="item">
                      <div class="product product-style-1">
                        <div class="img-wrapper">
                          <a href="/product-detail">
                            <img class="img-responsive" src="images/product/015.jpg" alt="product thumbnail">
                          </a>
                          <div class="product-control-wrapper bottom-right">
                            <div class="wrapper-control-item">
                              <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                        ...
                        <figcaption class="desc text-center">
                          <h3>
                            <a class="product-name" href="/product-detail">Pork</a>
                          </h3>
                    ...
                    <figure class="item">
                      <div class="product product-style-1">
                        <div class="img-wrapper">
                          <a href="/product-detail">
                            <img class="img-responsive" src="images/product/016.jpg" alt="product thumbnail">
                          </a>
                          <div class="product-control-wrapper bottom-right">
                            <div class="wrapper-control-item">
                              <a class="js-quick-view" href="#" type="button" data-toggle="modal" data-target="#quick-view-product">
                        ...
                        <figcaption class="desc text-center">
                          <h3>
                            <a class="product-name" href="/product-detail">Bacon</a>
                          </h3>
                          <span class="price">$4.80</span>
                        </figcaption>
                      </div>
